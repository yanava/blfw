...
enum wifi_msg_idx
{
	...
	wifi_cmd_hardware_set_soft_timer_idx =45,
	wifi_cmd_hardware_external_interrupt_config_idx =46,
	wifi_cmd_hardware_change_notification_config_idx =47,
	wifi_cmd_hardware_change_notification_pullup_idx =48,
	wifi_cmd_hardware_io_port_config_direction_idx =49,
	wifi_cmd_hardware_io_port_config_open_drain_idx =50,
	wifi_cmd_hardware_io_port_write_idx =51,
	wifi_cmd_hardware_io_port_read_idx =52,
	wifi_cmd_hardware_output_compare_idx =53,
	wifi_cmd_hardware_adc_read_idx =54,
	wifi_cmd_hardware_rtc_init_idx =55,
	wifi_cmd_hardware_rtc_set_time_idx =56,
	wifi_cmd_hardware_rtc_get_time_idx =57,
	wifi_cmd_hardware_rtc_set_alarm_idx =58,
	wifi_cmd_flash_ps_defrag_idx =59,
	wifi_cmd_flash_ps_dump_idx =60,
	wifi_cmd_flash_ps_erase_all_idx =61,
	wifi_cmd_flash_ps_save_idx =62,
	wifi_cmd_flash_ps_load_idx =63,
	wifi_cmd_flash_ps_erase_idx =64,
	wifi_cmd_i2c_start_read_idx =65,
	wifi_cmd_i2c_start_write_idx =66,
	wifi_cmd_i2c_stop_idx =67,
	wifi_cmd_https_enable_idx =68,
	wifi_cmd_ethernet_set_dataroute_idx =69,
	wifi_cmd_ethernet_close_idx =70,
	wifi_cmd_ethernet_connected_idx =71,
	wifi_rsp_dfu_reset_idx =72,
	wifi_rsp_dfu_flash_set_address_idx =73,
	wifi_rsp_dfu_flash_upload_idx =74,
	wifi_rsp_dfu_flash_upload_finish_idx =75,
	wifi_rsp_system_sync_idx =76,
	wifi_rsp_system_reset_idx =77,
	wifi_rsp_system_hello_idx =78,
	wifi_rsp_system_set_max_power_saving_state_idx =79,
	wifi_rsp_config_get_mac_idx =80,
	wifi_rsp_config_set_mac_idx =81,
	wifi_rsp_sme_wifi_on_idx =82,
	wifi_rsp_sme_wifi_off_idx =83,
	wifi_rsp_sme_power_on_idx =84,
	wifi_rsp_sme_start_scan_idx =85,
	wifi_rsp_sme_stop_scan_idx =86,
	wifi_rsp_sme_set_password_idx =87,
	wifi_rsp_sme_connect_bssid_idx =88,
	wifi_rsp_sme_connect_ssid_idx =89,
	wifi_rsp_sme_disconnect_idx =90,
	wifi_rsp_sme_set_scan_channels_idx =91,
	wifi_rsp_sme_set_operating_mode_idx =92,
	wifi_rsp_sme_start_ap_mode_idx =93,
	wifi_rsp_sme_stop_ap_mode_idx =94,
	wifi_rsp_sme_scan_results_sort_rssi_idx =95,
	wifi_rsp_sme_ap_client_disconnect_idx =96,
	wifi_rsp_sme_set_ap_password_idx =97,
	wifi_rsp_sme_set_ap_max_clients_idx =98,
	wifi_rsp_sme_start_wps_idx =99,
	wifi_rsp_sme_stop_wps_idx =100,
	wifi_rsp_sme_get_signal_quality_idx =101,
	wifi_rsp_tcpip_start_tcp_server_idx =102,
	wifi_rsp_tcpip_tcp_connect_idx =103,
	wifi_rsp_tcpip_start_udp_server_idx =104,
	wifi_rsp_tcpip_udp_connect_idx =105,
	wifi_rsp_tcpip_configure_idx =106,
	wifi_rsp_tcpip_dns_configure_idx =107,
	wifi_rsp_tcpip_dns_gethostbyname_idx =108,
	wifi_rsp_tcpip_udp_bind_idx =109,
	wifi_rsp_tcpip_dhcp_set_hostname_idx =110,
	wifi_rsp_endpoint_send_idx =111,
	wifi_rsp_endpoint_set_streaming_idx =112,
	wifi_rsp_endpoint_set_active_idx =113,
	wifi_rsp_endpoint_set_streaming_destination_idx =114,
	wifi_rsp_endpoint_close_idx =115,
	wifi_rsp_endpoint_set_transmit_size_idx =116,
	wifi_rsp_hardware_set_soft_timer_idx =117,
	wifi_rsp_hardware_external_interrupt_config_idx =118,
	wifi_rsp_hardware_change_notification_config_idx =119,
	wifi_rsp_hardware_change_notification_pullup_idx =120,
	wifi_rsp_hardware_io_port_config_direction_idx =121,
	wifi_rsp_hardware_io_port_config_open_drain_idx =122,
	wifi_rsp_hardware_io_port_write_idx =123,
	wifi_rsp_hardware_io_port_read_idx =124,
	wifi_rsp_hardware_output_compare_idx =125,
	wifi_rsp_hardware_adc_read_idx =126,
	wifi_rsp_hardware_rtc_init_idx =127,
	wifi_rsp_hardware_rtc_set_time_idx =128,
	wifi_rsp_hardware_rtc_get_time_idx =129,
	wifi_rsp_hardware_rtc_set_alarm_idx =130,
	wifi_rsp_flash_ps_defrag_idx =131,
	wifi_rsp_flash_ps_dump_idx =132,
	wifi_rsp_flash_ps_erase_all_idx =133,
	wifi_rsp_flash_ps_save_idx =134,
	wifi_rsp_flash_ps_load_idx =135,
	wifi_rsp_flash_ps_erase_idx =136,
	wifi_rsp_i2c_start_read_idx =137,
	wifi_rsp_i2c_start_write_idx =138,
	wifi_rsp_i2c_stop_idx =139,
	wifi_rsp_https_enable_idx =140,
	wifi_rsp_ethernet_set_dataroute_idx =141,
	wifi_rsp_ethernet_close_idx =142,
	wifi_rsp_ethernet_connected_idx =143,
	wifi_evt_dfu_boot_idx =144,
	wifi_evt_system_boot_idx =145,
	wifi_evt_system_state_idx =146,
	wifi_evt_system_sw_exception_idx =147,
	wifi_evt_system_power_saving_state_idx =148,
	wifi_evt_config_mac_address_idx =149,
	wifi_evt_sme_wifi_is_on_idx =150,
	wifi_evt_sme_wifi_is_off_idx =151,
	wifi_evt_sme_scan_result_idx =152,
	wifi_evt_sme_scan_result_drop_idx =153,
	wifi_evt_sme_scanned_idx =154,
	wifi_evt_sme_connected_idx =155,
	wifi_evt_sme_disconnected_idx =156,
	wifi_evt_sme_interface_status_idx =157,
	wifi_evt_sme_connect_failed_idx =158,
	wifi_evt_sme_connect_retry_idx =159,
	wifi_evt_sme_ap_mode_started_idx =160,
	wifi_evt_sme_ap_mode_stopped_idx =161,
	wifi_evt_sme_ap_mode_failed_idx =162,
	wifi_evt_sme_ap_client_joined_idx =163,
	wifi_evt_sme_ap_client_left_idx =164,
	wifi_evt_sme_scan_sort_result_idx =165,
	wifi_evt_sme_scan_sort_finished_idx =166,
	wifi_evt_sme_wps_stopped_idx =167,
	wifi_evt_sme_wps_completed_idx =168,
	wifi_evt_sme_wps_failed_idx =169,
	wifi_evt_sme_wps_credential_ssid_idx =170,
	wifi_evt_sme_wps_credential_password_idx =171,
	wifi_evt_sme_signal_quality_idx =172,
	wifi_evt_tcpip_configuration_idx =173,
	wifi_evt_tcpip_dns_configuration_idx =174,
	wifi_evt_tcpip_endpoint_status_idx =175,
	wifi_evt_tcpip_dns_gethostbyname_result_idx =176,
	wifi_evt_tcpip_udp_data_idx =177,
	wifi_evt_endpoint_syntax_error_idx =178,
	wifi_evt_endpoint_data_idx =179,
	wifi_evt_endpoint_status_idx =180,
	wifi_evt_endpoint_closing_idx =181,
	wifi_evt_endpoint_error_idx =182,
	wifi_evt_hardware_soft_timer_idx =183,
	wifi_evt_hardware_change_notification_idx =184,
	wifi_evt_hardware_external_interrupt_idx =185,
	wifi_evt_hardware_rtc_alarm_idx =186,
	wifi_evt_flash_ps_key_idx =187,
	wifi_evt_flash_ps_key_changed_idx =188,
	wifi_evt_https_on_req_idx =189,
	wifi_evt_https_button_idx =190,
	wifi_evt_ethernet_link_status_idx =191
};
